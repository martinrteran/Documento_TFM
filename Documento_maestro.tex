...
% Estilo
\usepackage{amsmath,amssymb,amsfonts,stackrel,hyperref,booktabs}
...
% Tikz
\usepackage{tikz}
\usetikzlibrary{matrix,chains,positioning,arrows,babel}
...
% Comandos
\newcommand{\fig}[1]{la figura~\ref{#1}}
% Definición del comando para ecuaciones
\newcommand{\eq}[1]{la ecuación~\eqref{#1}}

% O si prefieres referenciar solo la sigla con el número entre paréntesis:
...
\include{capitulos/fundamentos_teoricos}
