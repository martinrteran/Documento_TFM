...
\begin{itemize}
    ...
    \item El \textbf{Capítulo 3 (Metodología)} detalla formalmente el modelo matemático del POMDP, la cinemática discreta del robot de rejilla, la estructura del LiDAR por sectores angulares, la función de recompensa y las arquitecturas de las redes DQN/PPO aplicadas.
